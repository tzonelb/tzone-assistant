...
const navigationItems = [
  ...
  ["/publish", "Publish", SendOutlined, ["channels.view"]],
  ["/comments", "Comments", ForumOutlined, ["channels.view", "modules.comments"]],
  ["/customers", "Customers", GroupOutlined],
  ["/broadcast", "Broadcast", CampaignOutlined, ["channels.view"]],
  ["/calls", "Calls", CallOutlined],
  ["/dialer", "Dialer", SettingsPhoneOutlined],
  ["/catalogue", "Master Catalogue", Inventory2Outlined],
  ["/test-ai", "Test & Train AI", AutoAwesomeOutlined],
