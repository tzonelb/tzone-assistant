...
export const CHANNEL_CATEGORIES = [
  {
    ...
    channels: [
      ...
      { key: "whatsapp_qr", name: "WhatsApp (QR scan)", availability: "available", icon: "WhatsApp", color: "#25D366",
        note: "Scan a QR code with the phone's own WhatsApp app — no Meta developer account. Real risk, kept honest: WhatsApp's own detection has been confirmed to ban unofficial clients like this even with correct, low-volume usage, with no fix and no reliable appeal path. Meant as a bridge until your official WhatsApp Cloud API account is ready, not a permanent connection — test it, then decide." },
      ...
      { key: "facebook_direct", name: "Facebook (cookie download)", availability: "available", icon: "Facebook", color: "#1877F2",
        note: "Read-only: pulls your Page's public comments into your Comments queue using cookies exported from a browser you're signed in with, no Meta developer account. It cannot reply — do that from Facebook itself." },
