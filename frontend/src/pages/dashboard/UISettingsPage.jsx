    ...
    <section className="user-settings-shell">
      ...
      <main className="user-settings-content">
        <div className="user-settings-content-scroll">
          ...
          {active === "appearance" ? <section className="settings-section-card"><h3>New interface (beta)</h3><p>The redesigned navigation and layout, still being built screen by screen. Safe to try — switch back any time.</p><div className="settings-notification-row"><div><strong>Use the new interface</strong><span>Applies immediately in this browser only. Nobody else's session is affected.</span></div><Toggle checked={uiV2} onChange={(value) => { setUiV2(value); setUiV2Enabled(value); }} /></div></section> : null}
