...
export const CHANNEL_CATEGORIES = [
  {
    ...
    channels: [
      ...
      { key: "whatsapp_qr", name: "WhatsApp (QR scan)", availability: "available", connect: "whatsapp_qr", icon: "WhatsApp", color: "#25D366",
      ...
      { key: "instagram_direct", name: "Instagram (direct login)", availability: "available", connect: "instagram_direct", icon: "Instagram", color: "#E1306C",
        note: "Log in with your Instagram username and password — comments and posts, no Meta developer account." },
      { key: "facebook_direct", name: "Facebook (cookie download)", availability: "available", connect: "facebook_direct", icon: "Facebook", color: "#1877F2",
        note: "Download your Page's posts and comments using browser cookies — read-only, no Meta developer account." },
